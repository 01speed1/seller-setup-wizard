...
<form method="post" action="" class="dokan-social-form" novalidate>
    ...
    <?php //Nath said We dont need the role user ?> 
    ...
    <?php //set default customer role form client 
    //<p><input name="role" type="hidden"  value="customer"></p>
    ?>
...
<script>
        ( function ( $ ) {
            ...
            $( document ).ready( function () {
                ...
                //temp solution for redirect  this update form
                /* $('form.dokan-social-form').submit( function (e) {
                    e.preventDefault();
                    //commet to return normal flow
                    //let host = window.location.hostname
                    window.location.assign("/mi-cuenta/account-migration/seller/")
                } ) */
