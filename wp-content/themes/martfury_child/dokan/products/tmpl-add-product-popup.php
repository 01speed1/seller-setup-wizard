    ...
    <div id="dokan-add-new-product-popup" class="white-popup dokan-add-new-product-popup">
        ...
        <form action="" method="post" id="dokan-add-new-product-form">
            <div class="product-form-container">
                ...
                <!-- Se solicita cambio de texto en el drag & drop -->
                    <div class="dokan-feat-image-upload">
                        ...
                        <div class="instruction-inside<?php echo $instruction_class; ?>">
                            ...
                            <a href="#" class="dokan-feat-image-btn btn btn-sm">
                                <?php _e( 'Upload a product cover image', 'dokan-lite' ); ?>
                                <br> 
                                <span> Tamaño máximo de archivo: 8 MB </span> 
                            </a>
            ...
            <div class="product-container-footer">
                ...
                <input type="submit" id="dokan-create-new-product-btn" class="dokan-btn dokan-btn-theme" data-btn_id="create_new" value="<?php _e( 'Create product', 'dokan-lite' ) ?>">
                <?php /* ZONAWIKI OSCAR HIDE THIS BTN 
