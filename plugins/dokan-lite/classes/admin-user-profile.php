...
class Dokan_Admin_User_Profile {
    ...
    function add_meta_fields( $user ) {
        ...
        $store_settings['store_desc'] = get_user_meta( $user->ID, 'dokan_store_description', true );
        $store_settings['store_desc'] = isset( $store_settings['store_desc'] ) ? $store_settings['store_desc'] : '';
//        seller_percentage = get_user_meta( $user->ID, 'dokan_seller_percentage', true );
        ...
        <table class="form-table">
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <textarea type="text" name="dokan_store_description" class="regular-text" placeholder="<?php _e( 'Store Description', 'dokan-lite' ); ?>" value="<?php echo esc_attr( $store_settings['store_desc'] ); ?>"><?php echo esc_attr( $store_settings['store_desc'] ); ?></textarea>
                    </td>
                </tr>
    ...
    function save_meta_fields( $user_id ) {
        ...
        $store_settings['store_desc'] = sanitize_text_field( $_POST['dokan_store_description'] );
        ...
        update_user_meta( $user_id, 'dokan_store_description', $store_settings['store_desc'] );
